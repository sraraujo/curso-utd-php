<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div>
                    <a class="nav-link collapsed" href="index.php">
                        <div class="sb-nav-link-icon">
                            ...
                            <svg class="login" xmlns="http://www.w3.org/2000/svg" width="1.1rem" height="1.1rem" viewBox="0 4 512 512"><path fill="white" d="M256 64C150.13 64 64 150.13 64 256s86.13 192 192 192s192-86.13 192-192S361.87 64 256 64m80 294.63l-54.15-54.15a88.08 88.08 0 1 1 22.63-22.63L358.63 336Z"/><circle cx="232" cy="232" r="56" fill="white"/></svg>
                        </div>
                        Buscador
                    </a>
                </div>
        ...
        <div class="sb-sidenav-footer">
            ...
            <div class="small">
                Usuário: <span class="text-white"><?= $user["apelido"];?></span> <br>
                <hr>
                Sessão: <span class="text-white"><?= $user["loginAtual"];?></span>
            </div>
            <!-- Start Bootstrap -->
        </div>
    </nav>
