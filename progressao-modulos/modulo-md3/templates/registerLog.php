<?php
    ...
    $data = selecionar("log", null, null, $extra);
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Histórico de Registros</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Sistema Stock-X</a></li>
                            <li class="breadcrumb-item active">Histórico de Registros</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Histórico de Registros do Sistema
                            </div>
                            <div class="card-body">
