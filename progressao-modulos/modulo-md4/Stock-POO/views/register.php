...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?=Config::urlBase();?>/views/template/css/addAdim.css">
...
<body style="background-color: #233242;">
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-md-8 col-sm-12 mx-auto">
                    ...
                    <div style="display:flex;width:100%;" class="mt-2">
                        ...
                        <form action="<?=Config::urlBase()?>/controllers/register.php" method="POST">
                            ...
                            <input type="hidden" name="tipoAcesso" value="func">
    ...
    <!-- Js do formulário -->
    <script src="template/js/js-formulario.js"></script>
